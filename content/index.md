---
title: "Acho Não é Ter Certeza"
description: "Um material sobre comportamento de compra, percepção e comunicação — para donos de negócio que querem entender quem realmente compra deles."
---
...
<div style="text-align: center; margin: 2.5rem 0;">
  ...
  <a onclick="return false;" href="https://pay.hotmart.com/V105408718W?checkoutMode=2&coupon=100PRIMEIROS" class="hotmart-fb hotmart__button-checkout" style="display: inline-block; background: #C49A1E; color: #0F0F0F; font-weight: 700; font-size: 1.05rem; padding: 0.85rem 2rem; border-radius: 4px; letter-spacing: 0.02em; text-decoration: none; cursor: pointer;">
    Acessar oferta
  </a>
</div>
